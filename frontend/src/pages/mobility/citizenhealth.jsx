...
const Citizenhealthwellbeing = () => {
  const { data: mobilities, isLoading } = useFetch(
    "/mobilities?sort[0]=date:desc&populate=*"
  );
  ...
  return (
    <>
      ...
      <section className="city_en">
        <Page
          pageHeading={
            headerparagraphs?.[0]?.attributes.citizenhealthwellbeing_title
          }
          pagePara={
            headerparagraphs?.[0]?.attributes.citizenhealthwellbeing_paragraph
          }
