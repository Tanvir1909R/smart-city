...
const Mobilityconnectivity = () => {
  const { data: urbanspaces, isLoading } = useFetch(
    "/urbanspaces?sort[0]=date:desc&populate=*"
  );
  ...
  return (
    <>
      ...
      <section className="city_en">
        <Page
          pageHeading={
            headerparagraphs?.[0]?.attributes.mobilityconnectivity_title
          }
          pagePara={
            headerparagraphs?.[0]?.attributes.mobilityconnectivity_paragraph
          }
