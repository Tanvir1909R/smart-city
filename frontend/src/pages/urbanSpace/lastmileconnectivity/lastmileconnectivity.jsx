...
const Lastmileconnectivity = () => {
  const { data: culturalspaces, isLoading } = useFetch(
    "/culturalspaces?sort[0]=date:desc&populate=*"
  );
  ...
  return (
    <>
      ...
      <section className="city_en">
        <Page
          pageHeading={
            headerparagraphs?.[0]?.attributes.lastmileconnectivity_title
          }
          pagePara={
            headerparagraphs?.[0]?.attributes.lastmileconnectivity_paragraph
          }
