...
const Electricvehiclecharging = () => {
  const { data: electricvehicleandchargings, isLoading } = useFetch(
    "/electricvehicleandchargings?sort[0]=date:desc&populate=*"
  );
  ...
  return (
    <>
      ...
      <section className="city_en">
        <Page
          pageHeading={
            headerparagraphs?.[0]?.attributes.electricvehiclecharging_title
          }
          pagePara={
            headerparagraphs?.[0]?.attributes.electricvehiclecharging_paragraph
          }
