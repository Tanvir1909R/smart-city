...
const Trafficcongestion = () => {
  const { data: trafficcongestions, isLoading } = useFetch(
    "/trafficcongestions?sort[0]=date:desc&populate=*"
  );
  ...
  return (
    <>
      ...
      <section className="city_en">
        <Page
          pageHeading={
            headerparagraphs?.[0]?.attributes.trafficcongestion_title
          }
          pagePara={
            headerparagraphs?.[0]?.attributes.trafficcongestion_paragraph
          }
