...
const Emergencysystem = () => {
  const { data: citizensecurities, isLoading } = useFetch(
    "/citizensecurities?sort[0]=date:desc&populate=*"
  );
  ...
  return (
    <>
      ...
      <Page
        ...
        pagePara={headerparagraphs?.[0]?.attributes.emergencysystem_paragraph}
