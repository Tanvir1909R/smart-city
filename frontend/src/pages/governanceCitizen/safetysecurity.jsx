...
const Safetysecurity = () => {
  const { data: governancecitizens, isLoading } = useFetch(
    "/governancecitizens?sort[0]=date:desc&populate=*"
  );
    ...
    <>
      ...
      <section className="">
        <Page
          ...
          pagePara={headerparagraphs?.[0]?.attributes.safetysecurity_paragraph}
