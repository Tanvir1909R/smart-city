...
const Energyenvironment = () => {
  const { data: energyenvironments, isLoading } = useFetch(
    "/energyenvironments?sort[0]=date:desc&populate=*"
  );
  ...
  return (
    <>
      ...
      <section className="city_en">
        <Page
          pageHeading={
            headerparagraphs?.[0]?.attributes.energyenvironment_tilte
          }
          pagePara={
            headerparagraphs?.[0]?.attributes.energyenvironment_paragraph
          }
